...
final class TripadvisorKitTests: XCTestCase {
  ...
  func testLocatioDetail() async throws {
    ...
    XCTAssertEqual(location.webURL, URL(string: "https://www.tripadvisor.com/Attraction_Review-g32273-d13331376-Reviews-Apple_Park_Visitor_Center-Cupertino_California.html?m=66827")!)
    XCTAssertEqual(location.ancestors, [
    ...
    XCTAssertEqual(location.writeReview, URL(string: "https://www.tripadvisor.com/UserReview-g32273-d13331376-Apple_Park_Visitor_Center-Cupertino_California.html?m=66827")!)
    XCTAssertEqual(location.ranking, .init(geoLocationId: "32273", rankingString: "#3 of 30 things to do in Cupertino", geoLocationName: "Cupertino", rankingOutOf: "30", ranking: "3"))
    XCTAssertEqual(location.rating, "4.0")
    XCTAssertEqual(location.ratingImageUrl, URL(string: "https://www.tripadvisor.com/img/cdsi/img2/ratings/traveler/4.0-66827-5.svg")!)
    XCTAssertEqual(location.reviewRatingCount, ["2": "13", "5": "107", "4": "59", "3": "52", "1": "8"])
    XCTAssertEqual(location.photoCount, "424")
    XCTAssertEqual(location.seeAllPhotosURL, URL(string: "https://www.tripadvisor.com/Attraction_Review-g32273-d13331376-m66827-Reviews-Apple_Park_Visitor_Center-Cupertino_California.html#photos")!)
    ...
    XCTAssertEqual(location.category, .init(name: "attraction", localizedName: "Attraction", value: nil))
    XCTAssertEqual(location.subCategories, [
    ...
    XCTAssertEqual(location.tripTypes, [
